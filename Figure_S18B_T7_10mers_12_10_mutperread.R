...
data <- read.csv("T7_10mers_12_10_mutperread.csv", header = TRUE)

####Making your histogram####
Figure_S18B <- ggplot(data, aes(x=Mutation, y=Normalized, fill=Sample))+
...
ggsave(filename = 'Figure_S18B_T7_10mers_12_10_mutperread.png', path = getwd(), plot = Figure_S18B, scale = 2.5, width = 7.5, height = 5, units = "cm", dpi = 300)