...
#### Make the heatmap ####
T7_30mers_12_10_heatmap <- ggplot(Alignment_melt_sort2, aes(x = Position, y = tRNA, fill = countfactor))+
...
T7_30mers_12_10_heatmap

#### Save your heatmap as a .svg ####
ggsave(filename = 'T7_30mers_12_10_heatmap.svg', path = getwd(), plot = T7_30mers_12_10_heatmap, scale = 10, width = 5, height = 5, units = "cm", dpi = 300)