...
data <- read.csv("T7_10mers_11_05_mutperread.csv", header = TRUE)

####Making your histogram####
Figure_S18A <- ggplot(data, aes(x=Mutation, y=Normalized, fill=Sample))+
...
ggsave(filename = 'Figure_S18A_T7_10mers_11_05_mutperread.png', path = getwd(), plot = Figure_S18A, scale = 2.5, width = 7.5, height = 5, units = "cm", dpi = 300)