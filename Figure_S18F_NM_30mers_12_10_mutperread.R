...
data <- read.csv("NM_30mers_12_10_mutperread.csv", header = TRUE)

####Making your histogram####
Figure_S18F <- ggplot(data, aes(x=Mutation, y=Normalized, fill=Sample))+
...
ggsave(filename = 'Figure_S18F_NM_30mers_12_10_mutperread.png', path = getwd(), plot = Figure_S18F, scale = 2.5, width = 7.5, height = 5, units = "cm", dpi = 300)