...
data <- read.csv("Yphe_10mers_11_10_mutperread.csv", header = TRUE)

####Making your histogram####
Figure_S15B <- ggplot(data, aes(x=Mutation, y=Normalized, fill=Sample))+
...
ggsave(filename = 'Figure_S15B_Yphe_10mers_11_10_mutperread.png', path = getwd(), plot = Figure_S15B, scale = 2.5, width = 7.5, height = 5, units = "cm", dpi = 300)
